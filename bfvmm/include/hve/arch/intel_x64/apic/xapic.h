...
#ifndef XAPIC_INTEL_X64_BOXY_H
#define XAPIC_INTEL_X64_BOXY_H
...
public:
    ...
    /// @ensures
    ///
    /// @param vcpu the vcpu associated with this xapic
    ///
    /// @cond
    ///
    ...
    ///
    uint32_t id() const
    { return this->read(::intel_x64::lapic::id::indx); }
...
class EXPORT_BOXY_HVE insn_decoder
{
public:
