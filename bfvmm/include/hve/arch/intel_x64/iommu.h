...
#ifndef IOMMU_INTEL_X64_BOXY_H
#define IOMMU_INTEL_X64_BOXY_H
...
private:
    ...
    bfvmm::x64::unique_map<uint8_t> m_reg_map;
    uint8_t *m_hva{reinterpret_cast<uint8_t *>(hpa)};
...
///
#define g_iommu boxy::intel_x64::iommu::instance()
